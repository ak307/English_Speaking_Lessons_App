...
public class FirstPersonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_first_person, container, false);

        TextView conversationTextView = (TextView) view.findViewById(R.id.firstPersonConversationText);
        seekBar = (SeekBar) view.findViewById(R.id.firstPersonSeekBar);
        playBtn = (ImageView) view.findViewById(R.id.firstPersonbt_play);
        pauseBtn = (ImageView) view.findViewById(R.id.firstPersonbt_pause);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                initializeMediaPlayer(conversationData().getFirstPersonConversationUrl(), seekBar, playBtn, pauseBtn);
            }
        }, 300);
    ...
    private void addConversationData(TextView textView){
        String conversationText = conversationData().getFirstPersonConversationText();
